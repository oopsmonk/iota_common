...
void test_address_gen() {
  ...
  seed_from_base58(iota_seed, "7rxy9mMdYKjcqh4V1xHRvFK2FRMieRgzzt4txA2m8Hqq");
  size_t len = IOTA_ADDRESS_BASE58_LEN;
  seed_2_base58(ed25519_addr_str, &len, iota_seed);
  printf("seed: %s\n", ed25519_addr_str);

  get_address(ed25519_addr, iota_seed, 0, ADDRESS_VER_ED25519);
  address_2_base58(ed25519_addr_str, ed25519_addr);
  printf("addr: %s\n", ed25519_addr_str);
